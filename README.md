...
5.  **Оптимізація коду:** Для автоматизації конвертації даних між сутностями та DTO використовувалася бібліотека **MapStruct**.
6.  **Фронтенд:** Розроблений простий користувацький інтерфейс на **Thymeleaf** для візуальної демонстрації всього функціоналу.
