...
import com.product.shared.domain.model.ErrorResponse;
...
public final class ExceptionControllerAdvice {
    ...
    /**
     * Ловить усі винятки що наслідуються від {@link ApiException}, таким чином цей клас
     * виступає обгорткою над іншими винятками. Це дозволяє мати визначений ряд винятків, які
     * вертають статус код (і не тільки його), стандартизовано, уникаючи створення подібних винятків
